...
# НАДО БЫ ЗАНЯТЬСЯ ДЕЛОМ          from NewsPaper.source import secret_key
...
SECRET_KEY = 'django-insecure-^f*j)pl9ks+=s0cnj!8@oc7w7m&sf6qg@bt3ez6n#o4n0^allk'
...
EMAIL_HOST_PASSWORD = 'lsgllwpwkbbziqis'
EMAIL_USE_SSL = True
